...
add wave -noupdate -label tx_client_clk_0 -format Logic /testbench/dut/tx_client_clk_0
...
add wave -noupdate -label rx_client_clk_0 -format Logic /testbench/dut/rx_client_clk_0
