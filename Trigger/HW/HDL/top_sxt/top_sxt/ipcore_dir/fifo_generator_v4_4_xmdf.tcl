...
package provide fifo_generator_v4_4_xmdf 1.0
...
# is <core_name>_xmdf
namespace eval ::fifo_generator_v4_4_xmdf {
...
proc ::fifo_generator_v4_4_xmdf::xmdfInit { instance } {
# Variable containg name of library into which module is compiled
# Recommendation: <module_name>
# Required
utilities_xmdf::xmdfSetData $instance Module Attributes Name fifo_generator_v4_4
}
# ::fifo_generator_v4_4_xmdf::xmdfInit

# Function called by client to fill in all the xmdf* data variables
# based on the current settings of the parameters
proc ::fifo_generator_v4_4_xmdf::xmdfApplyParams { instance } {
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path fifo_generator_v4_4.asy
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path fifo_generator_v4_4.sym
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path fifo_generator_v4_4.vho
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount associated_module fifo_generator_v4_4
incr fcount
